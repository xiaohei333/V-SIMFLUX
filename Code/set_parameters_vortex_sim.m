function params = set_parameters_vortex_sim
...
params.fwd = 120e3;
params.depth = 0;
params.zrange = [-1000,1000];
params.zspread = [-1000,1000];
params.ztype =  'stage'; % 'medium'
% params.ztype =  'medium'; % 'medium'
params.lambda = 597.5;
params.lambdacentral = 597.5;
params.lambdaspread = [597.5,597.5];
params.xemit = 0.0;
params.yemit = 0.0;
params.zemit = 0.0;
params.Npupil = 32;
...
params.dipoletype = 'diffusion'; % 'free' 'fixed'
% params.dipoletype = 'free'; % 'free' 'fixed'
...
params.K = 1;
params.m = 1;
params.excitation = 'constant';

% fitting model
params.fitmodel = 'xyz-azim-pola-diffusion';
% params.fitmodel = 'xy-azim-pola-diffusion';
